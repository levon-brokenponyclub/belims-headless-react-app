  ...
  const calculateShipping = async (location: string) => {
    ...
    const mockOptions: ShippingOption[] = [
      ...
      },
      {
        ...
        isExpedited: true,
        aiRecommendation:
          "⚡ Perfect if you need to start painting this weekend",
      },
      {
        id: "economy",
        ...
        carbonImpact: 1.2,
        aiRecommendation:
          "🌱 Lowest environmental impact - great for non-urgent projects",
      },
    ];
    ...
    if (value >= 1000) {
      ...
      mockOptions[0].aiRecommendation =
        "🎉 Free shipping activated! Standard delivery at no extra cost";
    }
        ...
        <div className="flex items-center justify-between">
          ...
          {countdown.hours < 24 && (
            <div className="flex items-center gap-2 bg-orange-100 text-orange-800 px-3 py-1 rounded-full text-xs font-bold">
              ...
              Order in {countdown.hours}h {countdown.minutes}m for tomorrow
              delivery
            </div>
          )}
        </div>
              ...
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  ...
                  <p className="text-sm font-medium text-gray-900">
                    Estimated Arrival: {option.deliveryDate}
                  </p>
