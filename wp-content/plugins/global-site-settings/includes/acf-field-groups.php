...
acf_add_local_field_group(array(
    ...
    'fields' => array(
        array(
            'key' => 'field_belims_admin_colors',
            'label' => 'WordPress Admin Dashboard Colors',
            'name' => 'admin_dashboard_colors',
            'type' => 'group',
            'instructions' => 'Customize the WordPress admin dashboard color scheme',
            'sub_fields' => array(
                array(
                    'key' => 'field_belims_admin_bar_bg',
                    'label' => 'Admin Bar Background',
                    'name' => 'admin_bar_bg',
                    'type' => 'color_picker',
                    'instructions' => 'Top admin bar background color',
                    'default_value' => '#322783',
                ),
                array(
                    'key' => 'field_belims_admin_menu_bg',
                    'label' => 'Admin Menu Background',
                    'name' => 'admin_menu_bg',
                    'type' => 'color_picker',
                    'instructions' => 'Left sidebar menu background color',
                    'default_value' => '#322783',
                ),
                array(
                    'key' => 'field_belims_admin_submenu_bg',
                    'label' => 'Admin Submenu Background',
                    'name' => 'admin_submenu_bg',
                    'type' => 'color_picker',
                    'instructions' => 'Submenu background color',
                    'default_value' => '#4a3fc2',
                ),
                array(
                    'key' => 'field_belims_admin_menu_text',
                    'label' => 'Menu Item Text Color',
                    'name' => 'admin_menu_text',
                    'type' => 'color_picker',
                    'instructions' => 'Menu item text color',
                    'default_value' => '#ffffff',
                ),
                array(
                    'key' => 'field_belims_admin_accent',
                    'label' => 'Accent/Active Color',
                    'name' => 'admin_accent',
                    'type' => 'color_picker',
                    'instructions' => 'Accent color for active states, buttons, and links',
                    'default_value' => '#e40613',
                ),
            ),
        ),
    ),
