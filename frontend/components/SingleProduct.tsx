    ...
    <div className="relative">
      ...
      <div className="container mx-auto px-4 mb-0">
        ...
        >
          ...
          <div className="absolute inset-y-0 -left-[100vw] lg:right-[calc(55%+0.9rem)] bg-gray-50 z-10 hidden lg:block" />
          ...
          >
            ...
            <div className="flex-1 bg-[#F9F9F9] relative group cursor-zoom-in overflow-hidden flex flex-col">
              ...
              {!isMobile && (
                <div
                  className={`absolute bottom-4 left-4 right-4 bg-white rounded z-30 transition-all duration-500 ${
                    !showBuyBoxFull
                ...
                >
                  ...
                  {/* Payment & Security */}
                  <div className="border-t border-gray-200 bg-white pt-6 mt-4">
                    <div className="mb-3 centered-flex gap-2">
                      ...
                      <div className="flex flex-wrap justify-center gap-3 mb-0">
                        ...
                        <svg
                          ...
                          fill="none"
                        >
                          <g clip-path="url(#clip0_9598_4481)">
                            <path
                        ...
                        <svg
                          ...
                          fill="none"
                        >
                          <g clip-path="url(#clip0_9598_4484)">
                            <path
          ...
          {/* RIGHT COLUMN */}
          <div className="w-full lg:w-[54%] flex flex-col gap-3 py-10 pb-14 bg-white z-11 relative">
            {/* Header Info */}
            <div>
              <div className="mb-4">
            ...
            <div className="bg-white rounded p-0">
              ...
              <div className="prose prose-sm max-w-none text-gray-700 text-[13px] [&_strong]:font-bold [&_strong]:text-gray-900 [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:space-y-1 [&_ul]:mb-2 [&_li]:text-gray-700 [&_p]:mb-2">
                {product.description ? (
                  <div
