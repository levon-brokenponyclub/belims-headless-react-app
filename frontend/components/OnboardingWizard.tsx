...
export const OnboardingWizard: React.FC<OnboardingWizardProps> = ({
        ...
        <div className="bg-[#F5F5F7] w-full max-w-6xl rounded-3xl shadow-2xl overflow-hidden relative max-h-[90vh] flex flex-col">
          <div className="p-6 md:p-8 flex justify-between items-center bg-white border-b border-gray-200">
            <div>
              ...
              <h2 className="text-3xl font-bold font-heading text-black tracking-tight">
                Recommended for You
              </h2>
              <p className="text-gray-500 text-sm mt-1">
                Based on your project:{" "}
                <span className="italic text-gray-800">"{projectDesc}"</span>
              </p>
            </div>
            <button
              onClick={onClose}
  ...
  return (
    ...
    >
      <div
        className="w-full text-white overflow-auto font-sans shadow-2xl relative flex flex-col"
      ...
      >
        ...
        */}
        ...
        >
          ...
          <div
            className={`max-w-6xl mx-auto text-center transition-all duration-1200 transform ${showLanding ? "translate-y-0 opacity-100" : "translate-y-16 opacity-0"}`}
          >
            {/* Hero Typography */}
            <h1
            ...
            >
              Get the best deals, instant stock checks, and personalised
              recommendations for your projects, helping you save time and
              choose the right products effortlessly.
            </p>
            ...
            <div className="flex-shrink-0" style={styles.whiteSection}>
              ...
              <div
                className={`grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl mx-auto mb-5 transition-all duration-1000 ${featuresVisible ? "translate-y-0 opacity-100" : "translate-y-12 opacity-0"}`}
              >
                {/* Better Pricing Card */}
                <div
                ...
                >
                  ...
                  <h3 className="font-heading" style={styles.featureTitle}>
                    Better Pricing
                  </h3>
                  <p
              ...
              <div
                className={`flex justify-center transition-all duration-1200 delay-500 ${showLanding ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}
              >
                <button
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    >
                      ...
                      <div className="relative z-10">
                        ...
                        <p className="text-gray-500 font-medium">
                          For DIY projects and home improvements.
                        </p>
                      </div>
                    </button>
                    ...
                    >
                      ...
                      <div className="relative z-10">
                        ...
                        <p className="text-gray-500 font-medium">
                          For contractors, bulk orders, and tax invoices.
                        </p>
                      </div>
                    </button>
                  </div>
              ...
              {step === 3 && (
                <div className="max-w-2xl mx-auto w-full animate-fadeIn flex-1 flex flex-col">
                  ...
                  <p className="text-gray-500 text-center mb-10 text-lg">
                    Describe your project. We'll check stock and pricing
                    instantly.
                  </p>
